...
export default function OpponentForm({photo}) {
       ...
       const navigate=useNavigate();
        ...
        const {values,handleBlur,handleChange,handleSubmit,errors,resetForm}=useFormik({
          ...
          onSubmit: async (e,{resetForm}) => {
           setLoading(true)
           const response = await fetch(`${process.env.REACT_APP_API_URL}/api/opponentform`, {
               method: "POST",
               headers: {
        ...
        const isValid=values.date&&values.time&&values.contact&&values.address&&values.city&&image;
